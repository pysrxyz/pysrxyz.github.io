          ...
          <div className="mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                >
                  <Icon className="h-8 w-auto mr-2 bg-gray-300 rounded-full p-1 fill-transparent text-black" />
                </Link>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div className="hidden sm:flex space-x-4">
                  <a
                    href={"https://twitter.com/pysrxyz"}
                    className={classNames(
                ...
                <Menu as="div" className="relative ml-5">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-black py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <MenuItem href="https://twitter.com/pysrxyz">
                        <TwitterIcon className="h-6 w-6 mr-2 text-[#1da1f2]" />
                        <span>Twitter</span>
                      </MenuItem>
                      <MenuItem href="https://t.me/pysrxyz">
                        <TelegramIcon className="h-6 w-6 mr-2 text-[#2AABEE]" />
                        <span>Telegram</span>
                      </MenuItem>
                      <MenuItem href="https://github.com/pysrxyz">
